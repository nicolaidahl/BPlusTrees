...
\subsubsection{Improving the Asymptotic Running Time}
...
\todo{Jesper: You could also have used the built in maps in Coq. You should mention this and even look them up to understand them.}. This would add a large degree of complexity to our proofs, and since running time is not an objective of this project, it has been deemed out of scope.
