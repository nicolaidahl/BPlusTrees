...
While $valid\_splits$ argue about the overall sorting of the tree, we need to reason about the individual sorting of the key-pointer and key-value pairs within the nodes and leafs. For this reason we have introduced the inductive proposition $kvl\_sorted$. 
