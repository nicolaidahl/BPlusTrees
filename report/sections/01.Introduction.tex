...
% We use Coq
In the following report we discuss the implementation and formal proof of an inherently imperative data structure, B+ tree, in a pure functional language, Galina. \todo{Has this been done before? We need to put our work into some context}
\paragraph{}
\todo{Give an introduction to the main findings of the report}
